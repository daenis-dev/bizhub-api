...
@SpringBootTest
public class FindBackupFileNamesIT {
    ...
    @Test
    void findsBackupFileNames() {
        List<String> backupFileNames = findBackupFileNames.findFileNames();

        assertThat(backupFileNames).contains("test.txt");
    }
}
